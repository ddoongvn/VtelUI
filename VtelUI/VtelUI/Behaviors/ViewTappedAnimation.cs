...
namespace VtelUI.Behaviors
{
    public class ViewTappedAnimation : Behavior<View>
    {
        public static readonly BindableProperty AnimationTypeProperty =
            BindableProperty.Create(nameof(AnimationType), typeof(AnimationType), typeof(ViewTappedAnimation), AnimationType.Fade);
        ...
        public static readonly BindableProperty CommandProperty =
            BindableProperty.Create(nameof(Command), typeof(ICommand), typeof(ViewTappedAnimation), null, defaultBindingMode: BindingMode.TwoWay);
        ...
        public static readonly BindableProperty CommandParameterProperty =
            BindableProperty.Create(nameof(CommandParameter), typeof(object), typeof(ViewTappedAnimation), null);
        ...
        void View_Tapped(object sender, EventArgs e)
        {
            ...
            Device.BeginInvokeOnMainThread(async () =>
            {
                try
                {
                    ...
                    {
                        await view.ScaleTo(1.5, 170);
                        await view.ScaleTo(1, 170);
                    }
